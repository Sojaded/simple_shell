 ...
 *
 * Return: On success, 1. On error, -1 is returned, while errno is set appropriately.
 */
 ...
 *
 * Return: On success, 1. On error, -1 is returned, while errno will be set appropriately.
 */
